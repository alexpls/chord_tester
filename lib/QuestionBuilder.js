...
QuestionBuilder.prototype = {
  buildQuestions: function(numQuestions, numAnswers) {
    ...
    validateBuildQuestionsArgs.apply(this, arguments);
  ...
  pickPotentialAnswers: function(num) {
    return _.sampleSize(this.chords, num);
  }
};
...
function validateBuildQuestionsArgs() {
  ...
  if (this.chords.length < numAnswers) {
    throw new Error('Must have more chords than answers');
  }
}
